...
InteractiveActor::InteractiveActor(std::shared_ptr<CarrotQt5> gameRoot, double x, double y, bool fromEventMap)
    : CommonActor(gameRoot, x, y, fromEventMap), controllable(true) {
}
